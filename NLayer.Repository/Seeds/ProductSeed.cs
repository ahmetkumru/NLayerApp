    ...
    internal class ProductSeed : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                new Product { Id = 2, Name = "Kalem 2", CategoryId = 1, Price = 300, Stock = 30, CreatedDate = DateTime.Now },
                ...
                new Product { Id = 5, Name = "Kitap 2", CategoryId = 2, Price = 6600, Stock = 320, CreatedDate = DateTime.Now });
        }
    }
}
